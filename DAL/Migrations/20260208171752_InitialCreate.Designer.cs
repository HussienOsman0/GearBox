...
namespace DAL.Migrations
{
    ...
    [Migration("20260208171752_InitialCreate")]
            ...
            modelBuilder.Entity("DAL.Models.Booking", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Vehicle", "Vehicle")
                        .WithOne("booking")
                        .HasForeignKey("DAL.Models.Booking", "VehicleId")
            ...
            modelBuilder.Entity("DAL.Models.Client", b =>
                {
                    b.HasOne("DAL.Models.ApplicationUser", "user")
                        .WithOne("client")
                        .HasForeignKey("DAL.Models.Client", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Provider", b =>
                {
                    b.HasOne("DAL.Models.ApplicationUser", "User")
                        .WithOne("Provider")
                        .HasForeignKey("DAL.Models.Provider", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
